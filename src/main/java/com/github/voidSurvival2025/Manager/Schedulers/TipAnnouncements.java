...
public class TipAnnouncements implements Runnable {
    ...
    private final List<String> tips = List.of(
            ...
            "Make <color:#ffac12>Lava</color> by placing a lit campfire, \na cauldron, and 32 cobbled deepslate. Boom, Lava!",
            ...
            "Die by a player? You lose half a heart \nand drop everything except your hot-bar items. Oops!",
            "Eat a <color:#ffac12>Corian Root</color> to get your health back \nor even gain more hearts. Nom nom!",
